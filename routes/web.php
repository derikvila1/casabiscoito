...
Route::get('agendamento/casabiscoito/qrcode',  [AgendamentoVisitacaoController::class, 'qrcode'  ]);
Route::post('agendamento/casabiscoito/create', [AgendamentoVisitacaoController::class, 'store'  ]);
Route::get('agendamento/casabiscoito',         [AgendamentoVisitacaoController::class, 'index'  ]);
